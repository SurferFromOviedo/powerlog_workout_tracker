...
@Composable
fun SelectedExerciseItemForTemplateCreator(
    exercise: Exercise,
    unit: String?,
    onDelete: () -> Unit,
...
@Composable
fun PreviewSelectedExerciseItemForTemplateCreator() {
    val fakeExercise = Exercise("Deadlift", "Privet", "Kad dela",null)
    Workout_App_2Theme {
        SelectedExerciseItemForTemplateCreator(fakeExercise, unit = "KG", onDelete = {}, onExerciseChange = {})
    }
}